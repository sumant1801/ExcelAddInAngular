...
const projectsJsonData_1 = require("./config/projectsJsonData");
...
module.exports = yo.extend({
    ...
    prompting: function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let answerForUsageDataPrompt = yield this.prompt(promptForUsageData);
                ...
                let jsonData = new projectsJsonData_1.default(this.templatePath());
                ...
                let answerForProjectType = yield this.prompt(askForProjectType);
                ...
                let answerForScriptType = yield this.prompt(askForScriptType);
                ...
                let answerForName = yield this.prompt(askForName);
                ...
                let answerForHost = yield this.prompt(askForHost);
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (projectRepoBranchInfo.repo) {
                    yield helperMethods_1.helperMethods.downloadProjectTemplateZipFile(this.destinationPath(), projectRepoBranchInfo.repo, projectRepoBranchInfo.branch);
                    ...
                    yield childProcessExec(cmdLine);
                    // modify manifest guid and DisplayName
                    yield office_addin_manifest_1.modifyManifestFile(`${this.destinationPath()}/manifest.xml`, 'random', `${this.project.name}`);
                    return resolve();
                }
                else {
    ...
    _exitYoOfficeIfProjectFolderExists: function () {
        if (helperMethods_1.helperMethods.doesProjectFolderExist(this._destinationRoot)) {
